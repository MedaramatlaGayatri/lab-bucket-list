...
public class MapServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TouristPlace tourist = new TouristPlace(name,destination,rank);
	    MapOperations mapOperations = new MapOperations();
		if(add!=null) {
			// call the add method and store the return value in a map variable
			
			request.setAttribute("bucketList",mapOperations.add(tourist));
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketList", mapOperations.remove(tourist));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(sortRandom!=null) {
			...
			request.setAttribute("bucketList",mapOperations.sortRandomly(mapOperations.getList()));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(sortInEntryOrder!=null) {
			...
			request.setAttribute("bucketList",mapOperations.sortInEntryOrder(mapOperations.getList()));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		if(sortAlphabetically!=null) {
			...
			request.setAttribute("bucketList",mapOperations.sortAlphabetically(mapOperations.getList()));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {	
			...
			request.setAttribute("bucketList", mapOperations.reset(mapOperations.getList()));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
